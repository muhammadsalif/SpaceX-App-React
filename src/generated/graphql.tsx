...
export type LauchMissionInfoQueryVariables = Exact<{
  id: Scalars['String'];
}>;


export type LauchMissionInfoQuery = (
  { __typename?: 'Query' }
  & { launch?: Maybe<(
    { __typename?: 'Launch' }
...
export const LauchMissionInfoDocument = gql`
...
/**
 * __useLauchMissionInfoQuery__
 *
 * To run a query within a React component, call `useLauchMissionInfoQuery` and pass it any options that fit your needs.
 * When your component renders, `useLauchMissionInfoQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 ...
 * });
 */
export function useLauchMissionInfoQuery(baseOptions?: Apollo.QueryHookOptions<LauchMissionInfoQuery, LauchMissionInfoQueryVariables>) {
        return Apollo.useQuery<LauchMissionInfoQuery, LauchMissionInfoQueryVariables>(LauchMissionInfoDocument, baseOptions);
      }
export function useLauchMissionInfoLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<LauchMissionInfoQuery, LauchMissionInfoQueryVariables>) {
          return Apollo.useLazyQuery<LauchMissionInfoQuery, LauchMissionInfoQueryVariables>(LauchMissionInfoDocument, baseOptions);
        }
export type LauchMissionInfoQueryHookResult = ReturnType<typeof useLauchMissionInfoQuery>;
export type LauchMissionInfoLazyQueryHookResult = ReturnType<typeof useLauchMissionInfoLazyQuery>;
export type LauchMissionInfoQueryResult = Apollo.QueryResult<LauchMissionInfoQuery, LauchMissionInfoQueryVariables>;