...
export type MissionsInfoQuery = { __typename?: "Query" } & {
  launches?: Maybe<
    Array<
      Maybe<
        { __typename?: "Launch" } & Pick<
          Launch,
          "launch_success" | "launch_year" | "mission_id" | "mission_name"
        >
      >
    >
  >;
...
export type LaunchProfileQuery = { __typename?: "Query" } & {
  launch?: Maybe<
    { __typename?: "Launch" } & Pick<
      Launch,
      "mission_name" | "launch_year" | "launch_success" | "details"
    > & {
        launch_site?: Maybe<
 ...
 * });
 */
export function useMissionsInfoQuery(
  baseOptions?: Apollo.QueryHookOptions<
    MissionsInfoQuery,
    MissionsInfoQueryVariables
  >
) {
  return Apollo.useQuery<MissionsInfoQuery, MissionsInfoQueryVariables>(
    MissionsInfoDocument,
    baseOptions
  );
}
export function useMissionsInfoLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    MissionsInfoQuery,
    MissionsInfoQueryVariables
  >
) {
  return Apollo.useLazyQuery<MissionsInfoQuery, MissionsInfoQueryVariables>(
    MissionsInfoDocument,
    baseOptions
  );
}
export type MissionsInfoQueryHookResult = ReturnType<
  typeof useMissionsInfoQuery
>;
export type MissionsInfoLazyQueryHookResult = ReturnType<
  typeof useMissionsInfoLazyQuery
>;
export type MissionsInfoQueryResult = Apollo.QueryResult<
  MissionsInfoQuery,
  MissionsInfoQueryVariables
>;
